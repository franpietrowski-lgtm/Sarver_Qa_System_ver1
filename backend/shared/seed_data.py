"""Seed data: rubric library, default users, jobs, submissions, reviews, standards."""
import uuid
...
RUBRIC_LIBRARY = [
    {
        "id": "rubric_bed_edging_v1", "service_type": "bed edging", "division": "Maintenance",
        "title": "Bed Edging v1", "version": 1, "min_photos": 3, "pass_threshold": 78,
    ...
    {
        "id": "rubric_spring_cleanup_v1", "service_type": "spring cleanup", "division": "Maintenance",
        "title": "Spring Cleanup v1", "version": 1, "min_photos": 4, "pass_threshold": 80,
    ...
    {
        "id": "rubric_fall_cleanup_v1", "service_type": "fall cleanup", "division": "Maintenance",
        "title": "Fall Cleanup v1", "version": 1, "min_photos": 4, "pass_threshold": 81,
    ...
    {
        "id": "rubric_property_maintenance_v1", "service_type": "property maintenance", "division": "Maintenance",
        "title": "Property Maintenance v1", "version": 1, "min_photos": 3, "pass_threshold": 80,
    ...
    {
        "id": "rubric_pruning_v1", "service_type": "pruning", "division": "Maintenance",
        "title": "Pruning v1", "version": 1, "min_photos": 3, "pass_threshold": 82,
    ...
    {
        "id": "rubric_weeding_v1", "service_type": "weeding", "division": "Maintenance",
        "title": "Weeding v1", "version": 1, "min_photos": 3, "pass_threshold": 80,
    ...
    {
        "id": "rubric_mulching_v1", "service_type": "mulching", "division": "Maintenance",
        "title": "Mulching v1", "version": 1, "min_photos": 3, "pass_threshold": 82,
    ...
    {
        "id": "rubric_softscape_v1", "service_type": "softscape", "division": "Install",
        "title": "Softscape v1", "version": 1, "min_photos": 4, "pass_threshold": 83,
    ...
    {
        "id": "rubric_hardscape_v1", "service_type": "hardscape", "division": "Install",
        "title": "Hardscape v1", "version": 1, "min_photos": 4, "pass_threshold": 84,
    ...
    {
        "id": "rubric_tree_plant_install_removal_v1", "service_type": "tree/plant install/removal", "division": "Install",
        "title": "Tree/Plant Install/Removal v1", "version": 1, "min_photos": 4, "pass_threshold": 82,
    ...
    {
        "id": "rubric_drainage_trenching_v1", "service_type": "drainage/trenching", "division": "Install",
        "title": "Drainage/Trenching v1", "version": 1, "min_photos": 4, "pass_threshold": 82,
    ...
    {
        "id": "rubric_lighting_v1", "service_type": "lighting", "division": "Install",
        "title": "Lighting v1", "version": 1, "min_photos": 3, "pass_threshold": 83,
    ...
    {
        "id": "rubric_removal_v1", "service_type": "removal", "division": "Tree",
        "title": "Removal v1", "version": 1, "min_photos": 4, "pass_threshold": 84,
    ...
    {
        "id": "rubric_stump_grinding_v1", "service_type": "stump grinding", "division": "Tree",
        "title": "Stump Grinding v1", "version": 1, "min_photos": 3, "pass_threshold": 83,
    ...
    {
        "id": "rubric_fert_and_chem_treatments_v1", "service_type": "fert and chem treatments", "division": "Plant Healthcare",
        "title": "Fert and Chem Treatments v1", "version": 1, "min_photos": 2, "pass_threshold": 85,
    ...
    {
        "id": "rubric_air_spade_v1", "service_type": "air spade", "division": "Plant Healthcare",
        "title": "Air Spade v1", "version": 1, "min_photos": 3, "pass_threshold": 84,
    ...
    {
        "id": "rubric_dormant_pruning_v1", "service_type": "dormant pruning", "division": "Plant Healthcare",
        "title": "Dormant Pruning v1", "version": 1, "min_photos": 3, "pass_threshold": 84,
    ...
    {
        "id": "rubric_deer_fencing_and_shrub_treatment_v1", "service_type": "deer fencing and shrub treatment", "division": "Plant Healthcare",
        "title": "Deer Fencing and Shrub Treatment v1", "version": 1, "min_photos": 3, "pass_threshold": 83,
    ...
    {
        "id": "rubric_snow_removal_v1", "service_type": "snow removal", "division": "Winter Services",
        "title": "Snow Removal v1", "version": 1, "min_photos": 3, "pass_threshold": 85,
    ...
    {
        "id": "rubric_plow_v1", "service_type": "plow", "division": "Winter Services",
        "title": "Plow v1", "version": 1, "min_photos": 3, "pass_threshold": 84,
    ...
    {
        "id": "rubric_salting_v1", "service_type": "salting", "division": "Winter Services",
        "title": "Salting v1", "version": 1, "min_photos": 2, "pass_threshold": 85,
...
DEFAULT_STANDARDS = [
    {
        "title": "Clean bed edge finish", "category": "Edging", "audience": "crew",
        ...
        "owner_notes": "Great baseline example for edging crews.", "shoutout": "@North Crew",
        "image_url": "https://images.unsplash.com/photo-1734303023491-db8037a21f09?crop=entropy&cs=srgb&fm=jpg&ixlib=rb-4.1.0&q=85",
        "training_enabled": True, "question_type": "multiple_choice",
    ...
    {
        "title": "Mulch bed cleanliness", "category": "Mulch", "audience": "crew",
        ...
        "owner_notes": "Use for install coaching when edges are lost.", "shoutout": "@Install Team",
    ...
    {
        "title": "Cleanup completion proof", "category": "Cleanup", "audience": "crew",
        ...
        "owner_notes": "Best used for spring/fall cleanups.", "shoutout": "@Cleanup Team",
        "image_url": "https://images.unsplash.com/photo-1734079692160-fcbe4be6ab96?crop=entropy&cs=srgb&fm=jpg&ixlib=rb-4.1.0&q=85",
        "training_enabled": True, "question_type": "free_text",
        "question_prompt": "In one phrase, what makes this proof set feel complete?",
        "choice_options": [], "correct_answer": "clear final condition|final condition is obvious|complete reset",
    },
    {
        "title": "Tree pruning clarity", "category": "Pruning", "audience": "crew",
        ...
        "owner_notes": "Tree division standard example.", "shoutout": "@Tree Crew",
...
async def seed_defaults(db) -> None:
    """Seed users, rubrics, crews, jobs, submissions, reviews, standards."""
    ...
    for user in DEFAULT_USERS:
        ...
        if existing:
            await db.users.update_one(
                {"email": email_lower},
                {"$set": {"name": user["name"], "role": user["role"], "title": user["title"], "is_active": True, "updated_at": now_iso()}},
            )
        else:
            await db.users.delete_many({"email": {"$regex": f"^{user['email']}$", "$options": "i"}})
            await db.users.insert_one({
                "id": make_id("user"), **{**user, "email": email_lower},
    ...
    for rubric in RUBRIC_LIBRARY:
        ...
        document = {
            **rubric, "service_type": rubric["service_type"].lower(), "is_active": True,
    ...
    if await db.crew_access_links.count_documents({}) == 0:
        crew_links = [
            ...
            {"label": "South Crew", "truck_number": "TR-24", "division": "Maintenance"},
        ]
        await db.crew_access_links.insert_many([{
            "id": make_id("crew"), "code": uuid.uuid4().hex[:8], "crew_member_id": make_id("crewid").upper(),
            **item, "enabled": True, "created_at": now_iso(), "updated_at": now_iso(),
            "audit_history": [audit_entry("seeded", "system", "Crew QR access created")],
        } for item in crew_links])

    if await db.jobs.count_documents({}) == 0:
        jobs = [
            {"id": make_id("job"), "job_id": "LMN-4101", "job_name": "Riverview Estates Entry Beds", "property_name": "Riverview Estates", "address": "101 Riverside Dr", "service_type": "bed edging", "scheduled_date": (utc_now() + timedelta(days=1)).isoformat(), "division": "Install", "truck_number": "TR-12", "route": "North Route", "source": "seed", "search_text": "lmn-4101 riverview estates entry beds", "created_at": now_iso(), "updated_at": now_iso(), "audit_history": [audit_entry("seeded", "system", "Seed job loaded")]},
            {"id": make_id("job"), "job_id": "LMN-4102", "job_name": "Maple Grove Spring Reset", "property_name": "Maple Grove HOA", "address": "55 Maple Grove Ln", "service_type": "spring cleanup", "scheduled_date": utc_now().isoformat(), "division": "Maintenance", "truck_number": "TR-18", "route": "Central Route", "source": "seed", "search_text": "lmn-4102 maple grove spring cleanup", "created_at": now_iso(), "updated_at": now_iso(), "audit_history": [audit_entry("seeded", "system", "Seed job loaded")]},
            {"id": make_id("job"), "job_id": "LMN-4103", "job_name": "Willow Creek Fall Cleanup", "property_name": "Willow Creek Office Park", "address": "880 Willow Pkwy", "service_type": "fall cleanup", "scheduled_date": (utc_now() - timedelta(days=1)).isoformat(), "division": "Maintenance", "truck_number": "TR-24", "route": "South Route", "source": "seed", "search_text": "lmn-4103 willow creek fall cleanup", "created_at": now_iso(), "updated_at": now_iso(), "audit_history": [audit_entry("seeded", "system", "Seed job loaded")]},
            # 12 additional demo jobs spanning 120 days — maintenance tasks, varied names
    ...
    if await db.submissions.count_documents({}) == 0:
        ...
        if jobs and crew_links:
            await _seed_submissions(db, jobs, crew_links)

    if await db.standards_library.count_documents({}) == 0:
        await db.standards_library.insert_many([{
            "id": make_id("std"), **std, "is_active": True, "created_at": now_iso(), "updated_at": now_iso(),
        } for std in DEFAULT_STANDARDS])


async def _seed_submissions(db, jobs, crew_links):
    """Generate seed submissions, reviews, and rapid reviews."""
    ready_job, reviewed_job, finalized_job = jobs[0], jobs[1], jobs[2]
    ready_sub_id = make_id("sub")
    reviewed_sub_id = make_id("sub")
    finalized_sub_id = make_id("sub")

    def make_sub(sub_id, job, crew, status, note, area, days_ago, issue_type="", issue_notes=""):
        ...
        return {
            ...
            "status": status, "note": note, "area_tag": area,
            ...
            "work_date": (utc_now() - timedelta(days=days_ago)).strftime("%Y-%m-%d"), "captured_at": ts,
            "photo_count": 3, "required_photo_count": 3,
            "photo_files": [{"id": make_id("file"), "filename": f"seed-{sub_id[-6:]}-1.jpg", "mime_type": "image/jpeg", "sequence": 1, "source_type": "remote", "media_url": SEED_PHOTO_URLS[days_ago % len(SEED_PHOTO_URLS)]}],
            "storage_status": "seed_remote", "created_at": ts, "updated_at": ts,
            "audit_history": [audit_entry("seeded", "system", "Sample submission created")],
        }

    samples = [
        make_sub(ready_sub_id, ready_job, crew_links[0], "Ready for Review", "Seeded sample awaiting management scoring", "Front entry", 1),
        make_sub(reviewed_sub_id, reviewed_job, crew_links[1], "Management Reviewed", "Cleanup completed with minor clippings left in curb line", "Parking edge", 5),
        make_sub(finalized_sub_id, finalized_job, crew_links[2], "Export Ready", "Owner-approved gold sample", "Rear drainage swale", 10),
    ]
    ...
    for i in range(20):
        ...
        job = jobs[i % num_jobs]
        has_issue = i % 3 != 0
        samples.append(make_sub(sub_id, job, crew, statuses[i % len(statuses)], notes[i % len(notes)], areas[i % len(areas)], days_ago, issue_type=issue_types[i % len(issue_types)] if has_issue else "", issue_notes=f"Seed issue for repeat offender testing ({days_ago} days ago)" if has_issue else ""))
    ...
    await db.management_reviews.insert_one({
        "id": make_id("mgr"), "submission_id": reviewed_sub_id, "reviewer_id": management_user["id"],
        "rubric_id": spring_rubric["id"], "rubric_version": spring_rubric["version"], "service_type": "spring cleanup",
        "category_scores": {"coverage": 4, "cleanliness": 4, "bed_definition": 3, "turf_finish": 4, "curb_appeal": 4},
        "total_score": 77.6, "comments": "Good reset overall, minor curb clippings remain.", "disposition": "pass with notes",
        "flagged_issues": ["curb_line_cleanup"], "created_at": now_iso(), "updated_at": now_iso(),
        "audit_history": [audit_entry("seeded", management_user["id"], "Seed management review")],
    })
    await db.owner_reviews.insert_one({
        "id": make_id("own"), "submission_id": finalized_sub_id, "reviewer_id": owner_user["id"],
        "rubric_id": fall_rubric["id"], "rubric_version": fall_rubric["version"], "service_type": "fall cleanup",
        "category_scores": {"leaf_removal": 5, "detail_finish": 4, "bed_cleanup": 4, "walkway_clearance": 5, "visual_finish": 4},
        "total_score": 90.8, "comments": "Excellent gold-standard cleanup example.", "final_disposition": "pass",
        "training_inclusion": "approved", "exclusion_reason": "", "variance_from_management": 2.4,
    ...
    for i, sub in enumerate(samples[3:]):
        ...
        if i % 3 != 0:
            rapid_seeds.append({
                "id": make_id("rr"), "submission_id": sub["id"], "reviewer_id": management_user["id"],
                "overall_rating": ratings[i % len(ratings)], "issue_tag": issue_tags[i % len(issue_tags)],
                "remark": f"Seed rapid review for testing ({days_ago} days ago)", "time_spent_ms": 4500 + (i * 300),
                "created_at": ts, "updated_at": ts,
                "audit_history": [audit_entry("seeded", management_user["id"], "Seed rapid review")],
            })
    if rapid_seeds:
        await db.rapid_reviews.insert_many(rapid_seeds)
