...
from shared.deps import (
    make_id, now_iso, audit_entry, serialize, normalize_key, normalize_page, normalize_limit,
    build_paginated_response, get_storage_status_payload, storage_is_configured,
    upload_bytes_to_storage, download_bytes_from_storage, get_storage_bucket,
    build_submission_file_response_url, build_equipment_file_response_url, build_storage_path,
    build_missing_image_placeholder, hydrate_submission_media, find_submission_file_entry,
    get_submission_list_projection, get_jobs_projection, get_crew_link_projection, present_crew_link,
    get_current_user, require_roles,
    compute_match, get_active_rubric, calculate_total_score, create_submission_snapshot,
    calculate_rapid_review_score_summary, build_rapid_review_queue, match_training_answer,
    build_repeat_offender_summary, get_recent_training_sessions, select_training_snapshots,
    create_notification, write_json_artifact, utc_now, get_password_hash,
    SUBMISSIONS_DIR, EXPORTS_DIR, DATA_DIR, ANALYTICS_PERIODS, RAPID_REVIEW_RATING_MULTIPLIERS,
    get_period_cutoff, get_period_bucket, parse_iso_datetime, verify_password, create_access_token,
    get_supabase_client, dump_json_bytes,
)
...
deps.db = db  # Share db connection with deps module
